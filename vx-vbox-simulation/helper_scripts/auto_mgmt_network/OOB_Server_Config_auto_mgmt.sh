...
#    using topology data from: cumulus-ansible-beginner-ospf-j2.dot
...
REPOSITORY="https://github.com/CumulusNetworks/cumulus-ansible-beginner-ospf-j2"
REPONAME="cumulus-ansible-beginner-ospf-j2"

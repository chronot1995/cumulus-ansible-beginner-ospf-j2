...
#    using topology data from: begin-ansible-training-ospf-j2.dot
...
REPOSITORY="https://github.com/CumulusNetworks/begin-ansible-training-ospf-j2"
REPONAME="begin-ansible-training-ospf-j2"
